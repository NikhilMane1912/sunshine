package com.sagar.sunshine.sync;
...
import com.sagar.sunshine.BuildConfig;
import com.sagar.sunshine.MainActivity;
import com.sagar.sunshine.R;
import com.sagar.sunshine.Utility;
import com.sagar.sunshine.data.WeatherContract;
import com.sagar.sunshine.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static final String ACTION_DATA_UPDATED =
            "com.sagar.sunshine.ACTION_DATA_UPDATED";
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "dc0a3e4995c03322f725fbfb43449528")
                    .build();
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                if (i == 0) {
                    sendDataToWatch(high, low, weatherId);
                }
    ...
    private void sendDataToWatch(double highTemperature, double lowTemperature, int weatherConditionId) {
